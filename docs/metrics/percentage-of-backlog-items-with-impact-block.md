...
Percentage of backlog items that include a fully completed Impact Block (**effect type**, **dimensions**, **metric baseline & target**, and **verification method**).  
*(Kommentar: Dieser Teil kommt von mir "metric baseline & target, and verification method". Das macht für mich nur sinn, das direkt mit festzuhalten)*
...
## **Description**
This metric captures the percentage of backlog items that contain a fully completed Impact Block. **Each Impact Block specifies:**
