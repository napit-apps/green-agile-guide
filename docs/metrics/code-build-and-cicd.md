---
layout: default
title: Code, Build & CI/CD
nav_order: 3
parent:  Metrics & Impact
permalink: /metrics-and-impact/code-build-and-cicd
---
...
- **[Build Minutes per Change](/metrics-and-impact/code-build-and-cicd/build-minutes-per-change)**  
  Measures total build time per code change, highlighting pipeline efficiency and unnecessary compute usage.

- **[Test Runs per Change](/metrics-and-impact/code-build-and-cicd/test-runs-per-change)**  
