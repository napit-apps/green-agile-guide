---
layout: default
title: UX, Accessibility & Frontend Performance
nav_order: 5
parent:  Metrics & Impact
permalink: /metrics-and-impact/ux-accessibility-and-frontend-performance
---
...
- **[WCAG 2.2 Compliance Rate](/metrics-and-impact/ux-accessibility-and-frontend-performance/wcag-compliance-rate)**  
  Measures the percentage of applicable WCAG 2.2 criteria fulfilled, supporting inclusive and accessible user experiences.

- **[Largest Contentful Paint (LCP)](/metrics-and-impact/ux-accessibility-and-frontend-performance/lcp)**  
...
- **[Interaction to Next Paint (INP)](/metrics-and-impact/ux-accessibility-and-frontend-performance/inp)**  
  Measures responsiveness to user interactions, capturing how quickly the interface reacts to input.

- **[Time to First Byte (TTFB)](/metrics-and-impact/ux-accessibility-and-frontend-performance/ttfb)**  
  Measures the time until the first byte is received from the server, reflecting backend and network latency.

- **[Bytes per View](/metrics-and-impact/ux-accessibility-and-frontend-performance/bytes-per-view)**  
  Measures the amount of data transferred per page view, supporting data-efficient and energy-aware frontend design.

- **[Requests per View](/metrics-and-impact/ux-accessibility-and-frontend-performance/requests-per-view)**  
