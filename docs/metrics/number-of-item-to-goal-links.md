...
This metric measures how many backlog items explicitly reference a **Green Product Goal**, ensuring clear alignment between day-to-day work and long‑term sustainability direction. A higher number of linked items indicates that teams are consistently connecting tasks to strategic sustainability objectives, strengthening focus and coherence in product development.
...
## Classification
- **Scope:** Green Product Backlog / Strategic Alignment  
- **Category:** Transparency & Strategic Direction  
- **Effect Type:** indirect (strategic)  
...
**Formula:**  
\[
\text{Number of backlog items that reference a Green Product Goal}
\]
